...
// ...otras props y lógica del componente...
...
const AddAdminModal: React.FC<AddAdminModalProps> = ({ show, onClose, onAddAdmin }) => {
  ...
  return (
    <form>
      <div>
        <label htmlFor="adminUsername" className={labelClasses}>
          Nombre de Usuario (para login) <span className="text-red-500">*</span>
        </label>
        <input
          type="text"
          id="adminUsername"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <label htmlFor="adminConfirmPassword" className={labelClasses}>
            Confirmar Contraseña <span className="text-red-500">*</span>
          </label>
          {/* ...campo y validación de confirmación... */}
        </div>
      </div>

      <div>
        <label htmlFor="adminDisplayName" className={labelClasses}>
          Nombre Visible (para mostrar) <span className="text-red-500">*</span>
        </label>
        <input
          type="text"
          id="adminDisplayName"
