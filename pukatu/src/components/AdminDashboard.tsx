      ...
      <div className="min-h-screen bg-gradient-to-br from-[#12082e] to-[#1e1442] text-white font-['Montserrat'] flex flex-col items-center p-4 sm:p-6">
        ...
        <main className="w-full flex-grow flex flex-col items-center gap-8">
          <div className="w-full md:max-w-2xl lg:max-w-3xl"> 
            <h2 className="text-2xl font-['Orbitron'] text-center text-purple-300 mb-4">Ajustes Globales</h2>
            <AdminPanelSection
              ...
              currentMainRaffleTicketCost={currentMainRaffleTicketCost}
              onUpdateMainRaffleTicketCost={onUpdateMainRaffleTicketCost}
              currentQuickRaffleCost={currentQuickRaffleCost}
              onUpdateQuickRaffleCost={onUpdateQuickRaffleCost}
            />
          </div>
